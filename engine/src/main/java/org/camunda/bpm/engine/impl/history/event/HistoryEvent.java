...
public class HistoryEvent implements Serializable, DbEntity {
  ...
  public static final String INDENTITY_LINK_ADD = HistoryEventTypes.IDENTITY_LINK_ADD.getEventName();
  
  public static final String INDENTITY_LINK_DELETE = HistoryEventTypes.IDENTITY_LINK_DELETE.getEventName();
