...
public class DefaultHistoryEventProducer implements HistoryEventProducer {
  ...
  @Override
  public HistoryEvent createHistoricIdentitiyLinkAddEvent(IdentityLink identityLink) {
    return createHistoricIdentityLinkEvt(identityLink, HistoryEventTypes.IDENTITY_LINK_ADD);
  }

  @Override
  public HistoryEvent createHistoricIdentitiyLinkDeleteEvent(IdentityLink identityLink) {
