 ...
 * @author Joram Barrez
 */
public class BatchTestOrdering extends PluggableProcessEngineTestCase {
  ...
  public void testIt() {
    ...
    formProperties.put("custName", "Kermit");
    formProperties.put("custAdress", "Frogstreet 4");
    formProperties.put("orderItems", "Book 77");
